...
<div class="about">
  ...
  <div class="members">
    ...
    <p>"I am an Applied Physics major concentrating in computer science. Currently, I work in Colorado State
      ...
      I enjoy being outdoors and spending time with friends and family."</p>
  </div>
  <div class="members">
    Mariah Bradford
    <hr>
  ...
  <div class="members">
    ...
    <hr>
    <div>
      <?php echo Asset::img('backlira_profile.jpg'); ?>
    </div>
    <hr>
    <p>"Currently studying Computer Science at Colorado State University. I live in here in Ft. Collins and
      I work on campus for the ACNS Telecom department. In my spare time, I enjoy riding (05' Suzuki Boulevard)
      and gaming."</p>
  </div>
